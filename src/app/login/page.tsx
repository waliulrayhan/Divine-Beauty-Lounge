      ...
      <div className="bg-white p-10 rounded-2xl shadow-xl w-full max-w-md border border-[#D9CFF5]">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg text-base font-medium text-white bg-gradient-to-r from-[#6B4FA0] to-[#4C306D] hover:from-[#4C306D] hover:to-[#6B4FA0] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#6B4FA0] transition-all duration-300 shadow-lg hover:shadow-xl"
          >
            {isLoading ? (
